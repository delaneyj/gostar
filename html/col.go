...
func (e *ColHTMLElement) SPAN(v int) *ColHTMLElement {
...
func (e *ColHTMLElement) IfSPAN(cond bool, v int) *ColHTMLElement {
	if !cond {
		return e
	}
	return e.SPAN(v)
...
func (e *ColHTMLElement) RemoveSPAN(v int) *ColHTMLElement {
