...
func (e *SUBElement) DATASTAR_MERGE_STORE(v any) *SUBElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *SUBElement) DATASTAR_FETCH_URL(expression string) *SUBElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SUBElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *SUBElement {
	if condition {
...
func (e *SUBElement) DATASTAR_FETCH_URLRemove() *SUBElement {
	if e.StringAttributes == nil {
		return e
	}
