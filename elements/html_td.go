...
func (e *TDElement) DATASTAR_MERGE_STORE(v any) *TDElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *TDElement) DATASTAR_FETCH_URL(expression string) *TDElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *TDElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *TDElement {
	if condition {
...
func (e *TDElement) DATASTAR_FETCH_URLRemove() *TDElement {
	if e.StringAttributes == nil {
		return e
	}
