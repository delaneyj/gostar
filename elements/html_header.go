...
func (e *HEADERElement) DATASTAR_MERGE_STORE(v any) *HEADERElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *HEADERElement) DATASTAR_FETCH_URL(expression string) *HEADERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *HEADERElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *HEADERElement {
	if condition {
...
func (e *HEADERElement) DATASTAR_FETCH_URLRemove() *HEADERElement {
	if e.StringAttributes == nil {
		return e
	}
