...
type HeaderDataOnMod customDataKeyModifier

// Debounces the event handler
func HeaderDataOnModDebounce(
	d time.Duration,
) HeaderDataOnMod {
	return func() string {
...
func (e *HEADERElement) DATASTAR_ON(key string, expression string, modifiers ...HeaderDataOnMod) *HEADERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m HeaderDataOnMod, i int) customDataKeyModifier {
...
func (e *HEADERElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...HeaderDataOnMod) *HEADERElement {
	if condition {
...
func (e *HEADERElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *HEADERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *HEADERElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *HEADERElement {
	if condition {
