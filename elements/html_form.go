...
func (e *FORMElement) DATASTAR_FETCH_URL(expression string) *FORMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *FORMElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *FORMElement {
	if condition {
...
func (e *FORMElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *FORMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *FORMElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *FORMElement {
	if condition {
