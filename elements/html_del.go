...
func (e *DELElement) DATASTAR_MERGE_STORE(v any) *DELElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *DELElement) DATASTAR_FETCH_URL(expression string) *DELElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *DELElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *DELElement {
	if condition {
...
func (e *DELElement) DATASTAR_FETCH_URLRemove() *DELElement {
	if e.StringAttributes == nil {
		return e
	}
