...
func (e *SPANElement) DATASTAR_ON(key string, expression string, modifiers ...SpanDataOnMod) *SPANElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SPANElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...SpanDataOnMod) *SPANElement {
	if condition {
...
func (e *SPANElement) DATASTAR_FETCH_URL(expression string) *SPANElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SPANElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *SPANElement {
	if condition {
...
func (e *SPANElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SPANElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SPANElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SPANElement {
	if condition {
