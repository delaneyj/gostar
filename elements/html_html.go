...
func (e *HTMLElement) DATASTAR_MERGE_STORE(v any) *HTMLElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *HTMLElement) DATASTAR_FETCH_URL(expression string) *HTMLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *HTMLElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *HTMLElement {
	if condition {
...
func (e *HTMLElement) DATASTAR_FETCH_URLRemove() *HTMLElement {
	if e.StringAttributes == nil {
		return e
	}
