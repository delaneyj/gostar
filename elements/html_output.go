...
func (e *OUTPUTElement) DATASTAR_FETCH_URL(expression string) *OUTPUTElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *OUTPUTElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *OUTPUTElement {
	if condition {
