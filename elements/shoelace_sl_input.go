...
func (e *SLINPUTElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SLINPUTElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SLINPUTElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SLINPUTElement {
	if condition {
