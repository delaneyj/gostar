...
// them unchanged. 
    ...
    // Sets the URL for fetch requests 
        ...
        func(e *RUBYElement) DATASTAR_FETCH_URL(expression string) *RUBYElement{
                if e.StringAttributes == nil {
                    e.StringAttributes = treemap.New[string,string]()
                }
            ...
            func(e *RUBYElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *RUBYElement{
                if condition {
