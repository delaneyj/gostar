...
func (e *MathMLMSElement) DATASTAR_MERGE_STORE(v any) *MathMLMSElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
type MathMLMsDataOnMod customDataKeyModifier

// Debounces the event handler
func MathMLMsDataOnModDebounce(
	d time.Duration,
) MathMLMsDataOnMod {
	return func() string {
...
func MathMLMsDataOnModThrottle(
	d time.Duration,
) MathMLMsDataOnMod {
	return func() string {
...
func (e *MathMLMSElement) DATASTAR_ON(key string, expression string, modifiers ...MathMLMsDataOnMod) *MathMLMSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m MathMLMsDataOnMod, i int) customDataKeyModifier {
...
func (e *MathMLMSElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...MathMLMsDataOnMod) *MathMLMSElement {
	if condition {
...
func (e *MathMLMSElement) DATASTAR_FETCH_URL(expression string) *MathMLMSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *MathMLMSElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *MathMLMSElement {
	if condition {
...
func (e *MathMLMSElement) DATASTAR_FETCH_URLRemove() *MathMLMSElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *MathMLMSElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *MathMLMSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *MathMLMSElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *MathMLMSElement {
	if condition {
