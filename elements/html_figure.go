...
func (e *FIGUREElement) DATASTAR_MERGE_STORE(v any) *FIGUREElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *FIGUREElement) DATASTAR_FETCH_URL(expression string) *FIGUREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *FIGUREElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *FIGUREElement {
	if condition {
...
func (e *FIGUREElement) DATASTAR_FETCH_URLRemove() *FIGUREElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *FIGUREElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *FIGUREElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *FIGUREElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *FIGUREElement {
	if condition {
