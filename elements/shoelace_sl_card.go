...
func (e *SLCARDElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SLCARDElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SLCARDElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SLCARDElement {
	if condition {
