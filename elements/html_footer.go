...
func (e *FOOTERElement) DATASTAR_ON(key string, expression string, modifiers ...FooterDataOnMod) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *FOOTERElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...FooterDataOnMod) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_FETCH_URL(expression string) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *FOOTERElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *FOOTERElement {
	if condition {
...
func (e *FOOTERElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *FOOTERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *FOOTERElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *FOOTERElement {
	if condition {
