...
func (e *SOURCEElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SOURCEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SOURCEElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SOURCEElement {
	if condition {
