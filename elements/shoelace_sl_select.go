...
func (e *SLSELECTElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SLSELECTElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SLSELECTElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SLSELECTElement {
	if condition {
