...
type BxlIconFn func(children ...ElementRenderer) *BxlIcon

var IconLookup = map[string]BxlIconFn{
	"adobe":             Adobe,
	"airbnb":            Airbnb,
	"algolia":           Algolia,
	"amazon":            Amazon,
