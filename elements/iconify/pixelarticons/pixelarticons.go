...
type PixelarticonsIconFn func(children ...ElementRenderer) *PixelarticonsIcon

var IconLookup = map[string]PixelarticonsIconFn{
	"abTesting":                  AbTesting,
	"ac":                         Ac,
	"addBox":                     AddBox,
	...
	"artText":                    ArtText,
	"article":                    Article,
	"articleMultiple":            ArticleMultiple,
	...
	"bookmarks":                  Bookmarks,
	"briefcase":                  Briefcase,
	"briefcaseAccount":           BriefcaseAccount,
	"briefcaseCheck":             BriefcaseCheck,
	"briefcaseDelete":            BriefcaseDelete,
	"briefcaseDownload":          BriefcaseDownload,
	"briefcaseMinus":             BriefcaseMinus,
	"briefcasePlus":              BriefcasePlus,
	"briefcaseSearch":            BriefcaseSearch,
	"briefcaseSearchOne":         BriefcaseSearchOne,
	"briefcaseUpload":            BriefcaseUpload,
	"bug":                        Bug,
	"building":                   Building,
	...
	"calendarArrowLeft":          CalendarArrowLeft,
	...
	"calendarMultipleCheck":      CalendarMultipleCheck,
	"calendarPlus":               CalendarPlus,
	"calendarRange":              CalendarRange,
	"calendarRemove":             CalendarRemove,
	"calendarSearch":             CalendarSearch,
	"calendarSortAscending":      CalendarSortAscending,
	"calendarSortDescending":     CalendarSortDescending,
	...
	"cart":                       Cart,
	"cast":                       Cast,
	"cellularSignalOff":          CellularSignalOff,
	"cellularSignalOne":          CellularSignalOne,
	"cellularSignalThree":        CellularSignalThree,
	"cellularSignalTwo":          CellularSignalTwo,
	"cellularSignalZero":         CellularSignalZero,
	"chart":                      Chart,
	"chartAdd":                   ChartAdd,
	"chartBar":                   ChartBar,
	"chartDelete":                ChartDelete,
	"chartMinus":                 ChartMinus,
	...
	"chevronUp":                  ChevronUp,
	"chevronsHorizontal":         ChevronsHorizontal,
	"chevronsVertical":           ChevronsVertical,
	"circle":                     Circle,
	"clipboard":                  Clipboard,
	"clock":                      Clock,
	"close":                      Close,
	...
	"creditCardDelete":           CreditCardDelete,
	...
	"creditCardWireless":         CreditCardWireless,
	"crop":                       Crop,
	"cut":                        Cut,
	"dashbaord":                  Dashbaord,
	"debug":                      Debug,
	...
	"deviceTv":                   DeviceTv,
	"deviceTvSmart":              DeviceTvSmart,
	"deviceVibrate":              DeviceVibrate,
	...
	"hq":                         Hq,
	"human":                      Human,
	"humanHandsdown":             HumanHandsdown,
	"humanHandsup":               HumanHandsup,
	"humanHeight":                HumanHeight,
	"humanHeightAlt":             HumanHeightAlt,
	"humanRun":                   HumanRun,
	"image":                      Image,
	...
	"label":                      Label,
	"labelAlt":                   LabelAlt,
	"labelAltMultiple":           LabelAltMultiple,
	...
	"menu":                       Menu,
	"message":                    Message,
	"messageArrowLeft":           MessageArrowLeft,
	"messageArrowRight":          MessageArrowRight,
	"messageBookmark":            MessageBookmark,
	...
	"reciept":                    Reciept,
	"recieptAlt":                 RecieptAlt,
	"redo":                       Redo,
	"reload":                     Reload,
	"removeBox":                  RemoveBox,
	"removeBoxMultiple":          RemoveBoxMultiple,
	"repeat":                     Repeat,
	"reply":                      Reply,
	"replyAll":                   ReplyAll,
	...
	"shuffle":                    Shuffle,
	"sliders":                    Sliders,
	"slidersTwo":                 SlidersTwo,
	"sort":                       Sort,
	"sortAlpabetic":              SortAlpabetic,
