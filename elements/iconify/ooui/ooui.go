...
type OouiIconFn func(children ...ElementRenderer) *OouiIcon

var IconLookup = map[string]OouiIconFn{
	"add":                       Add,
	"alert":                     Alert,
	...
	"arrowNextLtr":              ArrowNextLtr,
	"arrowNextRtl":              ArrowNextRtl,
	"arrowPreviousLtr":          ArrowPreviousLtr,
	"arrowPreviousRtl":          ArrowPreviousRtl,
	"articleAdd":                ArticleAdd,
	"articleCheck":              ArticleCheck,
	"articleDisambiguationLtr":  ArticleDisambiguationLtr,
	"articleDisambiguationRtl":  ArticleDisambiguationRtl,
	"articleLtr":                ArticleLtr,
	"articleNotFoundLtr":        ArticleNotFoundLtr,
	"articleNotFoundRtl":        ArticleNotFoundRtl,
	"articleRedirectLtr":        ArticleRedirectLtr,
	"articleRedirectRtl":        ArticleRedirectRtl,
	"articleRtl":                ArticleRtl,
	"articleSearch":             ArticleSearch,
	"articlesLtr":               ArticlesLtr,
	"articlesRtl":               ArticlesRtl,
	"articlesSearchLtr":         ArticlesSearchLtr,
	"articlesSearchRtl":         ArticlesSearchRtl,
	...
	"block":                     Block,
	"boldA":                     BoldA,
	"boldArabAin":               BoldArabAin,
	"boldArabDad":               BoldArabDad,
	"boldArabJeem":              BoldArabJeem,
	"boldArmnTo":                BoldArmnTo,
	"boldB":                     BoldB,
	"boldCyrlBe":                BoldCyrlBe,
	"boldCyrlPalochka":          BoldCyrlPalochka,
	"boldCyrlTe":                BoldCyrlTe,
	"boldCyrlZhe":               BoldCyrlZhe,
	"boldF":                     BoldF,
	"boldG":                     BoldG,
	"boldGeorMan":               BoldGeorMan,
	"boldL":                     BoldL,
	"boldN":                     BoldN,
	"boldV":                     BoldV,
	"bookLtr":                   BookLtr,
	...
	"database":                  Database,
	"die":                       Die,
	"doubleChevronEndLtr":       DoubleChevronEndLtr,
	"doubleChevronEndRtl":       DoubleChevronEndRtl,
	"doubleChevronStartLtr":     DoubleChevronStartLtr,
	"doubleChevronStartRtl":     DoubleChevronStartRtl,
	"downTriangle":              DownTriangle,
	"download":                  Download,
	"draggable":                 Draggable,
	"edit":                      Edit,
	"editLock":                  EditLock,
	"editUndoLtr":               EditUndoLtr,
	"editUndoRtl":               EditUndoRtl,
	"ellipsis":                  Ellipsis,
	"errorIcon":                 ErrorIcon,
	...
	"eye":                       Eye,
	"eyeClosed":                 EyeClosed,
	"feedbackLtr":               FeedbackLtr,
	"feedbackRtl":               FeedbackRtl,
	"flagLtr":                   FlagLtr,
	"flagRtl":                   FlagRtl,
	"folderPlaceholderLtr":      FolderPlaceholderLtr,
	"folderPlaceholderRtl":      FolderPlaceholderRtl,
	"fullScreen":                FullScreen,
	"function":                  Function,
	"functionArgumentLtr":       FunctionArgumentLtr,
	"functionArgumentRtl":       FunctionArgumentRtl,
	"funnelLtr":                 FunnelLtr,
	"funnelRtl":                 FunnelRtl,
	"globe":                     Globe,
	"halfBrightLtr":             HalfBrightLtr,
	"halfBrightRtl":             HalfBrightRtl,
	"halfStarLtr":               HalfStarLtr,
	"halfStarRtl":               HalfStarRtl,
	"hand":                      Hand,
	"heart":                     Heart,
	"helpLtr":                   HelpLtr,
	"helpNoticeLtr":             HelpNoticeLtr,
	"helpNoticeRtl":             HelpNoticeRtl,
	"helpRtl":                   HelpRtl,
	...
	"home":                      Home,
	"image":                     Image,
	"imageAddLtr":               ImageAddLtr,
	"imageAddRtl":               ImageAddRtl,
	"imageBroken":               ImageBroken,
	"imageGallery":              ImageGallery,
	"imageLayoutBasic":          ImageLayoutBasic,
	"imageLayoutFrame":          ImageLayoutFrame,
	"imageLayoutFrameless":      ImageLayoutFrameless,
	"imageLayoutThumbnail":      ImageLayoutThumbnail,
	"imageLockLtr":              ImageLockLtr,
	"imageLockRtl":              ImageLockRtl,
	"indentLtr":                 IndentLtr,
	"indentRtl":                 IndentRtl,
	"info":                      Info,
	"infoFilled":                InfoFilled,
	"instanceLtr":               InstanceLtr,
	"instanceRtl":               InstanceRtl,
	"italicA":                   ItalicA,
	"italicArabKehehJeem":       ItalicArabKehehJeem,
	"italicArabMeem":            ItalicArabMeem,
	"italicArabTeh":             ItalicArabTeh,
	"italicArmnSha":             ItalicArmnSha,
	"italicC":                   ItalicC,
	"italicD":                   ItalicD,
	"italicE":                   ItalicE,
	"italicGeorKan":             ItalicGeorKan,
	"italicI":                   ItalicI,
	"italicK":                   ItalicK,
	"italicS":                   ItalicS,
	"journalLtr":                JournalLtr,
	"journalRtl":                JournalRtl,
	"key":                       Key,
	"keyboard":                  Keyboard,
	"labFlask":                  LabFlask,
	"language":                  Language,
	...
	"lightbulb":                 Lightbulb,
	"link":                      Link,
	"linkExternalLtr":           LinkExternalLtr,
	"linkExternalRtl":           LinkExternalRtl,
	"linkSecure":                LinkSecure,
	"listBulletLtr":             ListBulletLtr,
	"listBulletRtl":             ListBulletRtl,
	"listNumberedLtr":           ListNumberedLtr,
	"listNumberedRtl":           ListNumberedRtl,
	"literalLtr":                LiteralLtr,
	"literalRtl":                LiteralRtl,
	"lock":                      Lock,
	"logInLtr":                  LogInLtr,
	"logInRtl":                  LogInRtl,
	"logOutLtr":                 LogOutLtr,
	"logOutRtl":                 LogOutRtl,
	"logoCc":                    LogoCc,
	"logoMediaWiki":             LogoMediaWiki,
	"logoMetaWiki":              LogoMetaWiki,
	"logoWikibooks":             LogoWikibooks,
	"logoWikidata":              LogoWikidata,
	"logoWikifunctions":         LogoWikifunctions,
	"logoWikimedia":             LogoWikimedia,
	"logoWikimediaCommons":      LogoWikimediaCommons,
	"logoWikimediaDiscovery":    LogoWikimediaDiscovery,
	"logoWikinews":              LogoWikinews,
	"logoWikipedia":             LogoWikipedia,
	"logoWikiquote":             LogoWikiquote,
	"logoWikisource":            LogoWikisource,
	"logoWikispecies":           LogoWikispecies,
	"logoWikiversity":           LogoWikiversity,
	"logoWikivoyage":            LogoWikivoyage,
	"logoWiktionary":            LogoWiktionary,
	"mapLtr":                    MapLtr,
	"mapPin":                    MapPin,
	"mapPinAdd":                 MapPinAdd,
	"mapRtl":                    MapRtl,
	...
	"mathematicsDisplayBlock":   MathematicsDisplayBlock,
	"mathematicsDisplayDefault": MathematicsDisplayDefault,
	"mathematicsDisplayInline":  MathematicsDisplayInline,
	"menu":                      Menu,
	"message":                   Message,
	"moon":                      Moon,
	"move":                      Move,
	"moveFirstLtr":              MoveFirstLtr,
	"moveFirstRtl":              MoveFirstRtl,
	"moveLastLtr":               MoveLastLtr,
	"moveLastRtl":               MoveLastRtl,
	"musicalScore":              MusicalScore,
	"network":                   Network,
	"networkOff":                NetworkOff,
	"newWindowLtr":              NewWindowLtr,
	"newWindowRtl":              NewWindowRtl,
	"newlineLtr":                NewlineLtr,
	"newlineRtl":                NewlineRtl,
	"newspaperLtr":              NewspaperLtr,
	"newspaperRtl":              NewspaperRtl,
	"nextLtr":                   NextLtr,
	"nextRtl":                   NextRtl,
	"noWikiText":                NoWikiText,
	"notBright":                 NotBright,
	"notice":                    Notice,
	"ocr":                       Ocr,
	"ongoingConversationLtr":    OngoingConversationLtr,
	"ongoingConversationRtl":    OngoingConversationRtl,
	"outdentLtr":                OutdentLtr,
	"outdentRtl":                OutdentRtl,
	"outlineLtr":                OutlineLtr,
	"outlineRtl":                OutlineRtl,
	"pageSettings":              PageSettings,
	"paletteLtr":                PaletteLtr,
	"paletteRtl":                PaletteRtl,
	"pasteLtr":                  PasteLtr,
	"pasteRtl":                  PasteRtl,
	"pause":                     Pause,
	"play":                      Play,
	"previousLtr":               PreviousLtr,
	"previousRtl":               PreviousRtl,
	"printer":                   Printer,
	"pushPin":                   PushPin,
	"puzzleLtr":                 PuzzleLtr,
	"puzzleRtl":                 PuzzleRtl,
	...
	"quotesLtr":                 QuotesLtr,
	"quotesRtl":                 QuotesRtl,
	"recentChangesLtr":          RecentChangesLtr,
	"recentChangesRtl":          RecentChangesRtl,
	"redoLtr":                   RedoLtr,
	"redoRtl":                   RedoRtl,
	"reference":                 Reference,
	"referenceExistingLtr":      ReferenceExistingLtr,
	"referenceExistingRtl":      ReferenceExistingRtl,
	"referencesLtr":             ReferencesLtr,
	"referencesRtl":             ReferencesRtl,
	"reload":                    Reload,
	"restore":                   Restore,
	"robot":                     Robot,
	"sandbox":                   Sandbox,
	...
	"settings":                  Settings,
	"share":                     Share,
	"signatureLtr":              SignatureLtr,
	"signatureRtl":              SignatureRtl,
	"smaller":                   Smaller,
	"smallerText":               SmallerText,
	"specialCharacter":          SpecialCharacter,
	"specialPagesLtr":           SpecialPagesLtr,
	"specialPagesRtl":           SpecialPagesRtl,
	"speechBubbleAddLtr":        SpeechBubbleAddLtr,
	"speechBubbleAddRtl":        SpeechBubbleAddRtl,
	"speechBubbleLtr":           SpeechBubbleLtr,
	"speechBubbleRtl":           SpeechBubbleRtl,
	"speechBubblesLtr":          SpeechBubblesLtr,
	"speechBubblesRtl":          SpeechBubblesRtl,
	"star":                      Star,
	"stop":                      Stop,
	"strikethroughA":            StrikethroughA,
	"strikethroughS":            StrikethroughS,
	"strikethroughY":            StrikethroughY,
	"subscriptLtr":              SubscriptLtr,
	"subscriptRtl":              SubscriptRtl,
	"subtract":                  Subtract,
	"success":                   Success,
	"superscriptLtr":            SuperscriptLtr,
	"superscriptRtl":            SuperscriptRtl,
	"table":                     Table,
	"tableAddColumnAfterLtr":    TableAddColumnAfterLtr,
	"tableAddColumnAfterRtl":    TableAddColumnAfterRtl,
	"tableAddColumnBeforeLtr":   TableAddColumnBeforeLtr,
	"tableAddColumnBeforeRtl":   TableAddColumnBeforeRtl,
	"tableAddRowAfter":          TableAddRowAfter,
	"tableAddRowBefore":         TableAddRowBefore,
	"tableCaption":              TableCaption,
	"tableMergeCells":           TableMergeCells,
	"tableMoveColumnAfterLtr":   TableMoveColumnAfterLtr,
	"tableMoveColumnAfterRtl":   TableMoveColumnAfterRtl,
	"tableMoveColumnBeforeLtr":  TableMoveColumnBeforeLtr,
	"tableMoveColumnBeforeRtl":  TableMoveColumnBeforeRtl,
	"tableMoveRowAfter":         TableMoveRowAfter,
	"tableMoveRowBefore":        TableMoveRowBefore,
	"tagLtr":                    TagLtr,
	"tagRtl":                    TagRtl,
	"templateAddLtr":            TemplateAddLtr,
	"templateAddRtl":            TemplateAddRtl,
	"textDirLtr":                TextDirLtr,
	"textDirRtl":                TextDirRtl,
	"textFlowLtr":               TextFlowLtr,
	"textFlowRtl":               TextFlowRtl,
	"textStyle":                 TextStyle,
	"textSummaryLtr":            TextSummaryLtr,
	"textSummaryRtl":            TextSummaryRtl,
	"trash":                     Trash,
	"tray":                      Tray,
	"unBlock":                   UnBlock,
	"unFlagLtr":                 UnFlagLtr,
	...
	"underlineU":                UnderlineU,
	"undoLtr":                   UndoLtr,
	"undoRtl":                   UndoRtl,
	"upTriangle":                UpTriangle,
	"upload":                    Upload,
	"userActive":                UserActive,
	"userAddLtr":                UserAddLtr,
	"userAddRtl":                UserAddRtl,
	"userAnonymous":             UserAnonymous,
	"userAvatar":                UserAvatar,
	"userAvatarOutline":         UserAvatarOutline,
	"userContributionsLtr":      UserContributionsLtr,
	"userContributionsRtl":      UserContributionsRtl,
	"userGroupLtr":              UserGroupLtr,
	"userGroupRtl":              UserGroupRtl,
	"userRightsLtr":             UserRightsLtr,
	"userRightsRtl":             UserRightsRtl,
	"userTalkLtr":               UserTalkLtr,
	"userTalkRtl":               UserTalkRtl,
	"userTemporaryLtr":          UserTemporaryLtr,
	"userTemporaryRtl":          UserTemporaryRtl,
	"verticalEllipsis":          VerticalEllipsis,
	"viewCompact":               ViewCompact,
	"viewDetailsLtr":            ViewDetailsLtr,
	"viewDetailsRtl":            ViewDetailsRtl,
	"visionSimulator":           VisionSimulator,
	"volumeDownLtr":             VolumeDownLtr,
	"volumeDownRtl":             VolumeDownRtl,
	"volumeOffLtr":              VolumeOffLtr,
	"volumeOffRtl":              VolumeOffRtl,
	"volumeUpLtr":               VolumeUpLtr,
	"volumeUpRtl":               VolumeUpRtl,
	"watchlistLtr":              WatchlistLtr,
	"watchlistRtl":              WatchlistRtl,
	"wikiText":                  WikiText,
	"window":                    Window,
	"zoomIn":                    ZoomIn,
	"zoomOut":                   ZoomOut,
...
func ArticleNotFoundRtl(children ...ElementRenderer) *OouiIcon {
	return &OouiIcon{
		SVGSVGElement: SVG_SVG(
			Text(`<path fill="currentColor" d="M3 3v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2H5a2 2 0 0 0-2 
"/>`),
		).HEIGHT(hAttr).VIEW_BOX(viewbox).IfChildren(len(children) > 0, children...),
	}
}
...
func Code(children ...ElementRenderer) *OouiIcon {
	return &OouiIcon{
		SVGSVGElement: SVG_SVG(
			Text(`<path id="oouiCode0" fill="currentColor" d="M1 10.08V8.92h1.15c1.15 0 1.15 0 1.15-1.15V5a7.4 7.4 0 0 1 .09-1.3a2 2 0 0 1 .3-.7a1.84 1.84 0 0 1 .93-.68A6.4 6.4 0 0 1 6.74 2h1.18v1.15h-.86A1.32 1.32 0 0 0 6 3.62a1.7 1.7 0 0 0-.36 1.23V7a3.2 3.2 0 0 1-.28 1.72a2 2 0 0 1-1.26.77a2.15 2.15 0 0 1 1.26.79A3.26 3.26 0 0 1 5.62 12v3.15A1.67 1.67 0 0 0 6 16.37a1.31 1.31 0 0 0 1.08.47h.87V18H6.74a6.3 6.3 0 0 1-2.12-.29a1.82 1.82 0 0 1-.93-.71a1.9 1.9 0 0 1-.3-.72A7.5 7.5 0 0 1 3.31 15v-3.77c0-1.15 0-1.15-1.15-1.15zm18 0V8.92h-1.15c-1.15 0-1.15 0-1.15-1.15V5a7.4 7.4 0 0 0-.08-1.32a2 2 0 0 0-.3-.73a1.84 1.84 0 0 0-.93-.68A6.4 6.4 0 0 0 13.26 2h-1.18v1.15h.87a1.32 1.32 0 0 1 1.05.47a1.7 1.7 0 0 1 .36 1.23V7a3.2 3.2 0 0 0 .28 1.72a2 2 0 0 0 1.26.77a2.15 2.15 0 0 0-1.26.79a3.26 3.26 0 0 0-.26 1.72v3.15a1.67 1.67 0 0 1-.38 1.22a1.31 1.31 0 0 1-1.08.47h-.87V18h1.19a6.3 6.3 0 0 0 2.12-.29a1.82 1.82 0 0 0 .93-.68a1.9 1.9 0 0 0 .3-.72a7.5 7.5 0 0 0 .1-1.31v-3.77c0-1.15 0-1.15 1.15-1.15z"/><use href="#oouiCode0" transform="matrix(-1 0 0 1 20 0)"/>`),
		).HEIGHT(hAttr).VIEW_BOX(viewbox).IfChildren(len(children) > 0, children...),
	}
}
...
func FeedbackRtl(children ...ElementRenderer) *OouiIcon {
	return &OouiIcon{
		SVGSVGElement: SVG_SVG(
			Text(`<path fill="currentColor" d="M18 7c.6.7 1 1.6 1 2.5s-.4 1.8-1 2.5L1 16V3z"/><rect width="4" height="8" x="12" y="9" fill="currentColor" rx="2"/>`),
		).HEIGHT(hAttr).VIEW_BOX(viewbox).IfChildren(len(children) > 0, children...),
	}
}
...
func FunctionArgumentRtl(children ...ElementRenderer) *OouiIcon {
	return &OouiIcon{
		SVGSVGElement: SVG_SVG(
			Text(`<path fill="currentColor" d="M2 10a8 8 0 0 1 14.93-4h2.238A10 10 0 0 0 10 0C4.477 0 0 4.477 0 10s4.477 10 10 10c4.1 0 7.625-2.468 9.168-6H16.93A8 8 0 0 1 2 10m15.938-1H12V5l-6 5l6 5v-4h8V9z"/>`),
		).HEIGHT(hAttr).VIEW_BOX(viewbox).IfChildren(len(children) > 0, children...),
	}
}
...
func InstanceLtr(children ...ElementRenderer) *OouiIcon {
	return &OouiIcon{
		SVGSVGElement: SVG_SVG(
			Text(`<path fill="currentColor" d="M8.703 1.845L4.641 7.65l-.099.148L3 10l1.542 2.203q.048.076.1.148l2.914 4.164l1.147 1.64a2 2 0 0 1-2.783-.496l-4.558-6.512a2 2 0 0 1 0-2.294L5.92 2.341a2 2 0 0 1 2.783-.496m-2.341 9.302l4.558 6.512a2 2 0 0 0 3.277 0l4.559-6.512a2 2 0 0 0 0-2.294l-4.559-6.512a2 2 0 0 0-3.277 0L6.362 8.853a2 2 0 0 0 0 2.294m7.835-8.806L12.56 3.488L17.117 10l-4.558 6.512l-1.639 1.147l1.639-1.147L8 10l4.559-6.512z"/>`),
		).HEIGHT(hAttr).VIEW_BOX(viewbox).IfChildren(len(children) > 0, children...),
	}
}
...
func InstanceRtl(children ...ElementRenderer) *OouiIcon {
	return &OouiIcon{
		SVGSVGElement: SVG_SVG(
			Text(`<path fill="currentColor" d
"/>`),
		).HEIGHT(hAttr).VIEW_BOX(viewbox).IfChildren(len(children) > 0, children...),
	}
}
...
func SubscriptLtr(children ...ElementRenderer) *OouiIcon {
	return &OouiIcon{
		SVGSVGElement: SVG_SVG(
			Text(`<path fill="currentColor" d="M13.68 16h-2.42a.67.67 0 0 1-.46-.15a1.3 1.3 0 0 1-.28-.34l-2.77-4.44a2.7 2.7 0 0 1-.28.69L5 15.51a2.2 2.2 0 0 1-.29.34a.58.58 0 0 1-.42.15H2l4.15-6.19L2.17 4h2.42a.8.8 0 0 1 .41.09a.8.8 0 0 1 .24.26L8 8.59a2.7 2.7 0 0 1 .33-.74L10.6 4.4a.69.69 0 0 1 .6-.4h2.32l-4 5.71zm3.82-4h.5v-1h-.5a1.5 1.5 0 0 0-1 .39a1.5 1.5 0 0 0-1-.39H15v1h.5a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-.5.5H15v1h.5a1.5 1.5 0 0 0 1-.39a1.5 1.5 0 0 0 1 .39h.5v-1h-.5a.5.5 0 0 1-.5-.5v-6a.5.5 0 0 1 .5-.5"/>`),
		).HEIGHT(hAttr).VIEW_BOX(viewbox).IfChildren(len(children) > 0, children...),
	}
}
...
func TagRtl(children ...ElementRenderer) *OouiIcon {
	return &OouiIcon{
		SVGSVGElement: SVG_SVG(
			Text(`<path fill="currentColor" d="M7.6 18.7c.4.4 1 .4 1.4 0L18.7 9q.3-.3.3-.6V2c0-.6-.4-1-1-1h-6.4c-.2 0-.5.1-.6.3L1.3 11c-.4.4-.4 1-.1 1.3zM13 5c0-1.1.9-2 2-2s2 .9 2 2s-.9 2-2 2s-2-.9-2-2"/>`),
		).HEIGHT(hAttr).VIEW_BOX(viewbox).IfChildren(len(children) > 0, children...),
	}
}
...
func TextDirLtr(children ...ElementRenderer) *OouiIcon {
	return &OouiIcon{
		SVGSVGElement: SVG_SVG(
			Text(`<path fill="currentColor" d="m19 10l-6-5v4H6v2h7v4zM6 2V1H4.5a1.5 1.5 0 0 0-1 .39a1.5 1.5 0 0 0-1-.39H1v1h1.5a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-.5.5H1v1h1.5a1.5 1.5 0 0 0 1-.39a1.5 1.5 0 0 0 1 .39H6v-1H4.5a.5.5 0 0 1-.5-.5v-15a.5.5 0 0 1 .5-.5z"/>`),
		).HEIGHT(hAttr).VIEW_BOX(viewbox).IfChildren(len(children) > 0, children...),
	}
}
...
func TextDirRtl(children ...ElementRenderer) *OouiIcon {
	return &OouiIcon{
		SVGSVGElement: SVG_SVG(
			Text(`<path fill="currentColor" d="m1 10l6-5v4h7v2H7v4zm13-8V1h1.5a1.5 1.5 0 0 1 1 .39a1.5 1.5 0 0 1 1-.39H19v1h-1.5a.5.5 0 0 0-.5.5v15a.5.5 0 0 0 .5.5H19v1h-1.5a1.5 1.5 0 0 1-1-.39a1.5 1.5 0 0 1-1 .39H14v-1h1.5a.5.5 0 0 0 .5-.5v-15a.5.5 0 0 0-.5-.5z"/>`),
		).HEIGHT(hAttr).VIEW_BOX(viewbox).IfChildren(len(children) > 0, children...),
	}
}
...
func VolumeDownLtr(children ...ElementRenderer) *OouiIcon {
	return &OouiIcon{
		SVGSVGElement: SVG_SVG(
			Text(`<path fill="currentColor" d="m4 14l5.2 3.9c.3.3.8 0 .8-.5V2.6c0-.5-.5-.8-.8-.5L4 6m0 8H1c-.6 0-1-.4-1-1V7c0-.6.4-1 1-1h3m9.5 8.5c-.3 0-.5-.1-.7-.3c-.4-.4-.4-1 0-1.4c1.6-1.6 1.6-4.1 0-5.7c-.4-.4-.3-1.1.1-1.4s.9-.3 1.3 0c2.3 2.3 2.3 6.1 0 8.5c-.1.2-.4.3-.7.3"/>`),
		).HEIGHT(hAttr).VIEW_BOX(viewbox).IfChildren(len(children) > 0, children...),
	}
}
...
func VolumeDownRtl(children ...ElementRenderer) *OouiIcon {
	return &OouiIcon{
		SVGSVGElement: SVG_SVG(
			Text(`<path fill="currentColor" d="m15.925 14l-5.2 3.9c-.3.3-.8 0-.8-.5V2.6c0-.5.5-.8.8-.5l5.2 3.9m0 8h3c.6 0 1-.4 1-1V7c0-.6-.4-1-1-1h-3m-9.5 8.5c.3 0 .5-.1.7-.3c.4-.4.4-1 0-1.4c-1.6-1.6-1.6-4.1 0-5.7c.4-.4.3-1.1-.1-1.4s-.9-.3-1.3 0c-2.3 2.3-2.3 6.1 0 8.5c.1.2.4.3.7.3"/>`),
		).HEIGHT(hAttr).VIEW_BOX(viewbox).IfChildren(len(children) > 0, children...),
	}
}
