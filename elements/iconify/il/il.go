...
func Controls(children ...ElementRenderer) *SVGSVGElement {
	return SVG_SVG(
...
func Dialog(children ...ElementRenderer) *SVGSVGElement {
	return SVG_SVG(
...
func Market(children ...ElementRenderer) *SVGSVGElement {
	return SVG_SVG(
...
func Pie(children ...ElementRenderer) *SVGSVGElement {
	return SVG_SVG(
...
func SmallArrowDown(children ...ElementRenderer) *SVGSVGElement {
	return SVG_SVG(
...
func SmallArrowLeft(children ...ElementRenderer) *SVGSVGElement {
	return SVG_SVG(
...
func SmallArrowRight(children ...ElementRenderer) *SVGSVGElement {
	return SVG_SVG(
...
func SmallArrowUp(children ...ElementRenderer) *SVGSVGElement {
	return SVG_SVG(
...
func Thumbs(children ...ElementRenderer) *SVGSVGElement {
	return SVG_SVG(
