...
func (e *SVGFETURBULENCEElement) DATASTAR_FETCH_URL(expression string) *SVGFETURBULENCEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGFETURBULENCEElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *SVGFETURBULENCEElement {
	if condition {
...
func (e *SVGFETURBULENCEElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SVGFETURBULENCEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGFETURBULENCEElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SVGFETURBULENCEElement {
	if condition {
