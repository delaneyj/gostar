...
func (e *IElement) DATASTAR_MERGE_STORE(v any) *IElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *IElement) DATASTAR_FETCH_URL(expression string) *IElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *IElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *IElement {
	if condition {
...
func (e *IElement) DATASTAR_FETCH_URLRemove() *IElement {
	if e.StringAttributes == nil {
		return e
	}
