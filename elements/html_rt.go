...
func (e *RTElement) DATASTAR_ON(key string, expression string, modifiers ...RtDataOnMod) *RTElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *RTElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...RtDataOnMod) *RTElement {
	if condition {
...
func (e *RTElement) DATASTAR_FETCH_URL(expression string) *RTElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *RTElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *RTElement {
	if condition {
...
func (e *RTElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *RTElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *RTElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *RTElement {
	if condition {
