...
func (e *SVGFEMERGEElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SVGFEMERGEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGFEMERGEElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SVGFEMERGEElement {
	if condition {
