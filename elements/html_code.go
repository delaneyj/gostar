...
func (e *CODEElement) DATASTAR_FETCH_URL(expression string) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *CODEElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *CODEElement {
	if condition {
...
func (e *CODEElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *CODEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *CODEElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *CODEElement {
	if condition {
