...
func (e *ASIDEElement) DATASTAR_ON(key string, expression string, modifiers ...AsideDataOnMod) *ASIDEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *ASIDEElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...AsideDataOnMod) *ASIDEElement {
	if condition {
...
func (e *ASIDEElement) DATASTAR_FETCH_URL(expression string) *ASIDEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *ASIDEElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *ASIDEElement {
	if condition {
...
func (e *ASIDEElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *ASIDEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *ASIDEElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *ASIDEElement {
	if condition {
