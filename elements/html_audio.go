...
func (e *AUDIOElement) DATASTAR_FETCH_URL(expression string) *AUDIOElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *AUDIOElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *AUDIOElement {
	if condition {
...
func (e *AUDIOElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *AUDIOElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *AUDIOElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *AUDIOElement {
	if condition {
