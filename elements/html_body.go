...
func (e *BODYElement) DATASTAR_ON(key string, expression string, modifiers ...BodyDataOnMod) *BODYElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *BODYElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...BodyDataOnMod) *BODYElement {
	if condition {
...
func (e *BODYElement) DATASTAR_FETCH_URL(expression string) *BODYElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *BODYElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *BODYElement {
	if condition {
...
func (e *BODYElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *BODYElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *BODYElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *BODYElement {
	if condition {
