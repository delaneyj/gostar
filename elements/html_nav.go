...
func (e *NAVElement) DATASTAR_FETCH_URL(expression string) *NAVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *NAVElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *NAVElement {
	if condition {
...
func (e *NAVElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *NAVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *NAVElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *NAVElement {
	if condition {
