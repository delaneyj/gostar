...
func (e *H6Element) DATASTAR_ON(key string, expression string, modifiers ...H6DataOnMod) *H6Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *H6Element) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...H6DataOnMod) *H6Element {
	if condition {
...
func (e *H6Element) DATASTAR_FETCH_URL(expression string) *H6Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *H6Element) IfDATASTAR_FETCH_URL(condition bool, expression string) *H6Element {
	if condition {
...
func (e *H6Element) DATASTAR_VIEW_TRANSITION(key string, expression string) *H6Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *H6Element) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *H6Element {
	if condition {
