...
func (e *SVGFECOLORMATRIXElement) DATASTAR_FETCH_URL(expression string) *SVGFECOLORMATRIXElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGFECOLORMATRIXElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *SVGFECOLORMATRIXElement {
	if condition {
