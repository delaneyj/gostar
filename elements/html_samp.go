...
func (e *SAMPElement) DATASTAR_ON(key string, expression string, modifiers ...SampDataOnMod) *SAMPElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SAMPElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...SampDataOnMod) *SAMPElement {
	if condition {
...
func (e *SAMPElement) DATASTAR_FETCH_URL(expression string) *SAMPElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SAMPElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *SAMPElement {
	if condition {
...
func (e *SAMPElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SAMPElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SAMPElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SAMPElement {
	if condition {
