...
func (e *IFRAMEElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *IFRAMEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *IFRAMEElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *IFRAMEElement {
	if condition {
