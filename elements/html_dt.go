...
func (e *DTElement) DATASTAR_ON(key string, expression string, modifiers ...DtDataOnMod) *DTElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *DTElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...DtDataOnMod) *DTElement {
	if condition {
...
func (e *DTElement) DATASTAR_FETCH_URL(expression string) *DTElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *DTElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *DTElement {
	if condition {
...
func (e *DTElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *DTElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *DTElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *DTElement {
	if condition {
