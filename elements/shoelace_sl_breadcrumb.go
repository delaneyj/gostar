...
func (e *SLBREADCRUMBElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SLBREADCRUMBElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SLBREADCRUMBElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SLBREADCRUMBElement {
	if condition {
