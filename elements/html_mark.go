...
func (e *MARKElement) DATASTAR_ON(key string, expression string, modifiers ...MarkDataOnMod) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *MARKElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...MarkDataOnMod) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_FETCH_URL(expression string) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *MARKElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *MARKElement {
	if condition {
...
func (e *MARKElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *MARKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *MARKElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *MARKElement {
	if condition {
