...
func (e *SECTIONElement) DATASTAR_FETCH_URL(expression string) *SECTIONElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SECTIONElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *SECTIONElement {
	if condition {
...
func (e *SECTIONElement) DATASTAR_FETCH_URLRemove() *SECTIONElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SECTIONElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SECTIONElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SECTIONElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SECTIONElement {
	if condition {
