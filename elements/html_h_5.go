...
func (e *H5Element) DATASTAR_ON(key string, expression string, modifiers ...H5DataOnMod) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *H5Element) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...H5DataOnMod) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_FETCH_URL(expression string) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *H5Element) IfDATASTAR_FETCH_URL(condition bool, expression string) *H5Element {
	if condition {
...
func (e *H5Element) DATASTAR_VIEW_TRANSITION(key string, expression string) *H5Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *H5Element) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *H5Element {
	if condition {
