...
func (e *INSElement) DATASTAR_ON(key string, expression string, modifiers ...InsDataOnMod) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *INSElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...InsDataOnMod) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_FETCH_URL(expression string) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *INSElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *INSElement {
	if condition {
...
func (e *INSElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *INSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *INSElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *INSElement {
	if condition {
