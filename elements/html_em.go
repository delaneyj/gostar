...
func (e *EMElement) DATASTAR_ON(key string, expression string, modifiers ...EmDataOnMod) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *EMElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...EmDataOnMod) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_FETCH_URL(expression string) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *EMElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *EMElement {
	if condition {
...
func (e *EMElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *EMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *EMElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *EMElement {
	if condition {
