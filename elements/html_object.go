...
func (e *OBJECTElement) DATASTAR_MERGE_STORE(v any) *OBJECTElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *OBJECTElement) DATASTAR_FETCH_URL(expression string) *OBJECTElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *OBJECTElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *OBJECTElement {
	if condition {
...
func (e *OBJECTElement) DATASTAR_FETCH_URLRemove() *OBJECTElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *OBJECTElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *OBJECTElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *OBJECTElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *OBJECTElement {
	if condition {
