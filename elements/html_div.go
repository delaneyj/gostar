...
func (e *DIVElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *DIVElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *DIVElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *DIVElement {
	if condition {
