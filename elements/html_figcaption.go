...
func (e *FIGCAPTIONElement) DATASTAR_FETCH_URL(expression string) *FIGCAPTIONElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *FIGCAPTIONElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *FIGCAPTIONElement {
	if condition {
...
func (e *FIGCAPTIONElement) DATASTAR_FETCH_URLRemove() *FIGCAPTIONElement {
	if e.StringAttributes == nil {
		return e
	}
