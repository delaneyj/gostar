...
func (e *PElement) DATASTAR_ON(key string, expression string, modifiers ...PDataOnMod) *PElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *PElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...PDataOnMod) *PElement {
	if condition {
...
func (e *PElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *PElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *PElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *PElement {
	if condition {
