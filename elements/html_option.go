...
func (e *OPTIONElement) DATASTAR_ON(key string, expression string, modifiers ...OptionDataOnMod) *OPTIONElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *OPTIONElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...OptionDataOnMod) *OPTIONElement {
	if condition {
...
func (e *OPTIONElement) DATASTAR_FETCH_URL(expression string) *OPTIONElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *OPTIONElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *OPTIONElement {
	if condition {
...
func (e *OPTIONElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *OPTIONElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *OPTIONElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *OPTIONElement {
	if condition {
