...
func (e *TABLEElement) DATASTAR_FETCH_URL(expression string) *TABLEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *TABLEElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *TABLEElement {
	if condition {
...
func (e *TABLEElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *TABLEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *TABLEElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *TABLEElement {
	if condition {
