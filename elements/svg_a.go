...
func (e *SVGAElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SVGAElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGAElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SVGAElement {
	if condition {
