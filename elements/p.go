...
func P(children ...fmt.Stringer) *PElement {
    return &PElement{
...
func (e *PElement) AddChildren(children ...fmt.Stringer) *PElement {
...
func (e *PElement) RAW(text string) *PElement {
...
func (e *PElement) RemoveACCESSKEY(v string) *PElement {
...
func (e *PElement) RemoveAUTOCAPITALIZE(v string) *PElement {
...
func (e *PElement) RemoveAUTOFOCUS() *PElement {
    if e.BoolAttributes == nil {
        return e
    }
...
func (e *PElement) SetAUTOFOCUS(b bool) *PElement {
    if b {
        return e.AUTOFOCUS()
    }
...
func (e *PElement) SetCLASS(v string) *PElement {
    kv := gostar.NewSpaceDelimitedString()
    e.DelimitedStringAttributes["class"] = kv
    kv.Add(v)
    return e
...
func (e *PElement) RemoveCLASS(v string) *PElement {
    kv, ok := e.DelimitedStringAttributes["class"]
    if !ok {
        return e
    }
...
func (e *PElement) RemoveCONTENTEDITABLE(v string) *PElement {
...
func (e *PElement) RemoveDIR(v string) *PElement {
...
func (e *PElement) RemoveDRAGGABLE(v string) *PElement {
...
func (e *PElement) RemoveENTERKEYHINT(v string) *PElement {
...
func (e *PElement) RemoveHIDDEN(v string) *PElement {
...
func (e *PElement) RemoveID(v string) *PElement {
...
func (e *PElement) RemoveINERT() *PElement {
    if e.BoolAttributes == nil {
        return e
    }
...
func (e *PElement) SetINERT(b bool) *PElement {
    if b {
        return e.INERT()
    }
...
func (e *PElement) RemoveINPUTMODE(v string) *PElement {
...
func (e *PElement) RemoveIS(v string) *PElement {
...
func (e *PElement) RemoveITEMID(v string) *PElement {
...
func (e *PElement) RemoveITEMPROP(v string) *PElement {
...
func (e *PElement) RemoveITEMREF(v string) *PElement {
...
func (e *PElement) RemoveITEMSCOPE() *PElement {
    if e.BoolAttributes == nil {
        return e
    }
...
func (e *PElement) SetITEMSCOPE(b bool) *PElement {
    if b {
        return e.ITEMSCOPE()
    }
...
func (e *PElement) RemoveITEMTYPE(v string) *PElement {
...
func (e *PElement) RemoveLANG(v string) *PElement {
...
func (e *PElement) RemoveNONCE(v string) *PElement {
...
func (e *PElement) RemovePOPOVER(v string) *PElement {
...
func (e *PElement) RemoveSLOT(v string) *PElement {
...
func (e *PElement) RemoveSPELLCHECK(v string) *PElement {
...
func (e *PElement) RemoveSTYLE(k string) *PElement {
    kv, ok := e.DelimitedKVAttributes["style"]
    if !ok {
        return e
    }
...
func (e *PElement) RemoveTABINDEX(v string) *PElement {
...
func (e *PElement) RemoveTITLE(v string) *PElement {
...
func (e *PElement) RemoveTRANSLATE(v string) *PElement {
