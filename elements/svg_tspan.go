...
func (e *SVGTSPANElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SVGTSPANElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGTSPANElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SVGTSPANElement {
	if condition {
