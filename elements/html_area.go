...
func (e *AREAElement) DATASTAR_FETCH_URL(expression string) *AREAElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *AREAElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *AREAElement {
	if condition {
...
func (e *AREAElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *AREAElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *AREAElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *AREAElement {
	if condition {
