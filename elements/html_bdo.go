...
func (e *BDOElement) DATASTAR_MERGE_STORE(v any) *BDOElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *BDOElement) DATASTAR_FETCH_URL(expression string) *BDOElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *BDOElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *BDOElement {
	if condition {
...
func (e *BDOElement) DATASTAR_FETCH_URLRemove() *BDOElement {
	if e.StringAttributes == nil {
		return e
	}
