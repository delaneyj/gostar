...
func (e *ABBRElement) DATASTAR_ON(key string, expression string, modifiers ...AbbrDataOnMod) *ABBRElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *ABBRElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...AbbrDataOnMod) *ABBRElement {
	if condition {
...
func (e *ABBRElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *ABBRElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *ABBRElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *ABBRElement {
	if condition {
