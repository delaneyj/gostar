...
func (e *SVGFEDIFFUSELIGHTINGElement) DATASTAR_FETCH_URL(expression string) *SVGFEDIFFUSELIGHTINGElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGFEDIFFUSELIGHTINGElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *SVGFEDIFFUSELIGHTINGElement {
	if condition {
...
func (e *SVGFEDIFFUSELIGHTINGElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SVGFEDIFFUSELIGHTINGElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGFEDIFFUSELIGHTINGElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SVGFEDIFFUSELIGHTINGElement {
	if condition {
