...
// User agents should ignore leading zeros. 
    ...
    // Setup the ViewTransitionAPI for the element 
        ...
        func(e *MathMLMATHElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *MathMLMATHElement{
                if e.StringAttributes == nil {
                    e.StringAttributes = treemap.New[string,string]()
                }
            ...
            func(e *MathMLMATHElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *MathMLMATHElement{
                if condition {
