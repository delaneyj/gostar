...
func (e *HRElement) DATASTAR_MERGE_STORE(v any) *HRElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *HRElement) DATASTAR_FETCH_URL(expression string) *HRElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *HRElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *HRElement {
	if condition {
...
func (e *HRElement) DATASTAR_FETCH_URLRemove() *HRElement {
	if e.StringAttributes == nil {
		return e
	}
