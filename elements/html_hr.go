...
type HrDataOnMod customDataKeyModifier

// Debounces the event handler
func HrDataOnModDebounce(
	d time.Duration,
) HrDataOnMod {
	return func() string {
...
func (e *HRElement) DATASTAR_ON(key string, expression string, modifiers ...HrDataOnMod) *HRElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m HrDataOnMod, i int) customDataKeyModifier {
...
func (e *HRElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...HrDataOnMod) *HRElement {
	if condition {
...
func (e *HRElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *HRElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *HRElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *HRElement {
	if condition {
