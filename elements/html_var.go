...
func (e *VARElement) DATASTAR_MERGE_STORE(v any) *VARElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *VARElement) DATASTAR_FETCH_URL(expression string) *VARElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *VARElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *VARElement {
	if condition {
...
func (e *VARElement) DATASTAR_FETCH_URLRemove() *VARElement {
	if e.StringAttributes == nil {
		return e
	}
