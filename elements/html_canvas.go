...
func (e *CANVASElement) DATASTAR_FETCH_URL(expression string) *CANVASElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *CANVASElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *CANVASElement {
	if condition {
