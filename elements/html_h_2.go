...
func (e *H2Element) DATASTAR_ON(key string, expression string, modifiers ...H2DataOnMod) *H2Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *H2Element) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...H2DataOnMod) *H2Element {
	if condition {
...
func (e *H2Element) DATASTAR_FETCH_URL(expression string) *H2Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *H2Element) IfDATASTAR_FETCH_URL(condition bool, expression string) *H2Element {
	if condition {
...
func (e *H2Element) DATASTAR_VIEW_TRANSITION(key string, expression string) *H2Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *H2Element) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *H2Element {
	if condition {
