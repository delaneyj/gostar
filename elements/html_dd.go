...
func (e *DDElement) DATASTAR_ON(key string, expression string, modifiers ...DdDataOnMod) *DDElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *DDElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...DdDataOnMod) *DDElement {
	if condition {
...
func (e *DDElement) DATASTAR_FETCH_URL(expression string) *DDElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *DDElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *DDElement {
	if condition {
...
func (e *DDElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *DDElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *DDElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *DDElement {
	if condition {
