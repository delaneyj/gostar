...
func (e *COLElement) DATASTAR_ON(key string, expression string, modifiers ...ColDataOnMod) *COLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *COLElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...ColDataOnMod) *COLElement {
	if condition {
...
func (e *COLElement) DATASTAR_FETCH_URL(expression string) *COLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *COLElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *COLElement {
	if condition {
...
func (e *COLElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *COLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *COLElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *COLElement {
	if condition {
