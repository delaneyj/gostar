...
func (e *SVGDESCElement) DATASTAR_FETCH_URL(expression string) *SVGDESCElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGDESCElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *SVGDESCElement {
	if condition {
...
func (e *SVGDESCElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SVGDESCElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGDESCElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SVGDESCElement {
	if condition {
