...
type HgroupDataOnMod customDataKeyModifier

// Debounces the event handler
func HgroupDataOnModDebounce(
	d time.Duration,
) HgroupDataOnMod {
	return func() string {
...
func (e *HGROUPElement) DATASTAR_ON(key string, expression string, modifiers ...HgroupDataOnMod) *HGROUPElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m HgroupDataOnMod, i int) customDataKeyModifier {
...
func (e *HGROUPElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...HgroupDataOnMod) *HGROUPElement {
	if condition {
...
func (e *HGROUPElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *HGROUPElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *HGROUPElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *HGROUPElement {
	if condition {
