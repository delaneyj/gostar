...
func (e *HGROUPElement) DATASTAR_MERGE_STORE(v any) *HGROUPElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *HGROUPElement) DATASTAR_FETCH_URL(expression string) *HGROUPElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *HGROUPElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *HGROUPElement {
	if condition {
...
func (e *HGROUPElement) DATASTAR_FETCH_URLRemove() *HGROUPElement {
	if e.StringAttributes == nil {
		return e
	}
