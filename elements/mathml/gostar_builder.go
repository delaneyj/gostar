...
func (e *ElementBuilder) Attr(name string, value string) *ElementBuilder {
...
func (e *ElementBuilder) Attrs(attrs ...string) *ElementBuilder {
	if len(attrs)%2 != 0 {
...
func (e *ElementBuilder) AttrsMap(attrs map[string]string) *ElementBuilder {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	for k, v := range attrs {
...
func (e *ElementBuilder) Render(w io.Writer) error {
	w.Write(openBracket)
	w.Write(e.Tag)
...
func NewElement(tag string, children ...ElementRenderer) *ElementBuilder {
