...
func (e *TITLEElement) DATASTAR_MERGE_STORE(v any) *TITLEElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *TITLEElement) DATASTAR_FETCH_URL(expression string) *TITLEElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *TITLEElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *TITLEElement {
	if condition {
...
func (e *TITLEElement) DATASTAR_FETCH_URLRemove() *TITLEElement {
	if e.StringAttributes == nil {
		return e
	}
