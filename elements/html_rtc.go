...
func (e *RTCElement) DATASTAR_ON(key string, expression string, modifiers ...RtcDataOnMod) *RTCElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *RTCElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...RtcDataOnMod) *RTCElement {
	if condition {
...
func (e *RTCElement) DATASTAR_FETCH_URL(expression string) *RTCElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *RTCElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *RTCElement {
	if condition {
...
func (e *RTCElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *RTCElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *RTCElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *RTCElement {
	if condition {
