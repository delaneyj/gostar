...
func (e *H1Element) DATASTAR_MERGE_STORE(v any) *H1Element {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *H1Element) DATASTAR_FETCH_URL(expression string) *H1Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *H1Element) IfDATASTAR_FETCH_URL(condition bool, expression string) *H1Element {
	if condition {
...
func (e *H1Element) DATASTAR_FETCH_URLRemove() *H1Element {
	if e.StringAttributes == nil {
		return e
	}
