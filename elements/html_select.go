...
func (e *SELECTElement) DATASTAR_FETCH_URL(expression string) *SELECTElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SELECTElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *SELECTElement {
	if condition {
...
func (e *SELECTElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SELECTElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SELECTElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SELECTElement {
	if condition {
