...
func (e *SVGMETADATAElement) DATASTAR_FETCH_URL(expression string) *SVGMETADATAElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGMETADATAElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *SVGMETADATAElement {
	if condition {
