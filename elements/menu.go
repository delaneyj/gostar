...
func MENU(children ...fmt.Stringer) *MenuElement {
    return &MenuElement{
...
func (e *MenuElement) AddChildren(children ...fmt.Stringer) *MenuElement {
...
func (e *MenuElement) RAW(text string) *MenuElement {
...
func (e *MenuElement) RemoveACCESSKEY(v string) *MenuElement {
...
func (e *MenuElement) RemoveAUTOCAPITALIZE(v string) *MenuElement {
...
func (e *MenuElement) RemoveAUTOFOCUS() *MenuElement {
    if e.BoolAttributes == nil {
        return e
    }
...
func (e *MenuElement) SetAUTOFOCUS(b bool) *MenuElement {
    if b {
        return e.AUTOFOCUS()
    }
...
func (e *MenuElement) SetCLASS(v string) *MenuElement {
    kv := gostar.NewSpaceDelimitedString()
    e.DelimitedStringAttributes["class"] = kv
    kv.Add(v)
    return e
...
func (e *MenuElement) RemoveCLASS(v string) *MenuElement {
    kv, ok := e.DelimitedStringAttributes["class"]
    if !ok {
        return e
    }
...
func (e *MenuElement) RemoveCONTENTEDITABLE(v string) *MenuElement {
...
func (e *MenuElement) RemoveDIR(v string) *MenuElement {
...
func (e *MenuElement) RemoveDRAGGABLE(v string) *MenuElement {
...
func (e *MenuElement) RemoveENTERKEYHINT(v string) *MenuElement {
...
func (e *MenuElement) RemoveHIDDEN(v string) *MenuElement {
...
func (e *MenuElement) RemoveID(v string) *MenuElement {
...
func (e *MenuElement) RemoveINERT() *MenuElement {
    if e.BoolAttributes == nil {
        return e
    }
...
func (e *MenuElement) SetINERT(b bool) *MenuElement {
    if b {
        return e.INERT()
    }
...
func (e *MenuElement) RemoveINPUTMODE(v string) *MenuElement {
...
func (e *MenuElement) RemoveIS(v string) *MenuElement {
...
func (e *MenuElement) RemoveITEMID(v string) *MenuElement {
...
func (e *MenuElement) RemoveITEMPROP(v string) *MenuElement {
...
func (e *MenuElement) RemoveITEMREF(v string) *MenuElement {
...
func (e *MenuElement) RemoveITEMSCOPE() *MenuElement {
    if e.BoolAttributes == nil {
        return e
    }
...
func (e *MenuElement) SetITEMSCOPE(b bool) *MenuElement {
    if b {
        return e.ITEMSCOPE()
    }
...
func (e *MenuElement) RemoveITEMTYPE(v string) *MenuElement {
...
func (e *MenuElement) RemoveLANG(v string) *MenuElement {
...
func (e *MenuElement) RemoveNONCE(v string) *MenuElement {
...
func (e *MenuElement) RemovePOPOVER(v string) *MenuElement {
...
func (e *MenuElement) RemoveSLOT(v string) *MenuElement {
...
func (e *MenuElement) RemoveSPELLCHECK(v string) *MenuElement {
...
func (e *MenuElement) RemoveSTYLE(k string) *MenuElement {
    kv, ok := e.DelimitedKVAttributes["style"]
    if !ok {
        return e
    }
...
func (e *MenuElement) RemoveTABINDEX(v string) *MenuElement {
...
func (e *MenuElement) RemoveTITLE(v string) *MenuElement {
...
func (e *MenuElement) RemoveTRANSLATE(v string) *MenuElement {
