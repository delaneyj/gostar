...
func (e *SVGFEFUNCBElement) DATASTAR_ON(key string, expression string, modifiers ...SVGFeFuncBDataOnMod) *SVGFEFUNCBElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGFEFUNCBElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...SVGFeFuncBDataOnMod) *SVGFEFUNCBElement {
	if condition {
...
func (e *SVGFEFUNCBElement) DATASTAR_FETCH_URL(expression string) *SVGFEFUNCBElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGFEFUNCBElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *SVGFEFUNCBElement {
	if condition {
...
func (e *SVGFEFUNCBElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SVGFEFUNCBElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGFEFUNCBElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SVGFEFUNCBElement {
	if condition {
