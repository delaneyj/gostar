...
func (e *THElement) DATASTAR_FETCH_URL(expression string) *THElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *THElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *THElement {
	if condition {
...
func (e *THElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *THElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *THElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *THElement {
	if condition {
