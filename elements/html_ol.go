...
func (e *OLElement) DATASTAR_ON(key string, expression string, modifiers ...OlDataOnMod) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *OLElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...OlDataOnMod) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_FETCH_URL(expression string) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *OLElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *OLElement {
	if condition {
...
func (e *OLElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *OLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *OLElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *OLElement {
	if condition {
