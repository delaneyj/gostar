...
func (e *HEADElement) DATASTAR_ON(key string, expression string, modifiers ...HeadDataOnMod) *HEADElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *HEADElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...HeadDataOnMod) *HEADElement {
	if condition {
...
func (e *HEADElement) DATASTAR_FETCH_URL(expression string) *HEADElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *HEADElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *HEADElement {
	if condition {
...
func (e *HEADElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *HEADElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *HEADElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *HEADElement {
	if condition {
