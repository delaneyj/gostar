...
func (e *DETAILSElement) DATASTAR_MERGE_STORE(v any) *DETAILSElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *DETAILSElement) DATASTAR_FETCH_URL(expression string) *DETAILSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *DETAILSElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *DETAILSElement {
	if condition {
...
func (e *DETAILSElement) DATASTAR_FETCH_URLRemove() *DETAILSElement {
	if e.StringAttributes == nil {
		return e
	}
