...
func (e *MathMLMFRACElement) DATASTAR_ON(key string, expression string, modifiers ...MathMLMfracDataOnMod) *MathMLMFRACElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *MathMLMFRACElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...MathMLMfracDataOnMod) *MathMLMFRACElement {
	if condition {
...
func (e *MathMLMFRACElement) DATASTAR_FETCH_URL(expression string) *MathMLMFRACElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *MathMLMFRACElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *MathMLMFRACElement {
	if condition {
...
func (e *MathMLMFRACElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *MathMLMFRACElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *MathMLMFRACElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *MathMLMFRACElement {
	if condition {
