...
func (e *SUMMARYElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SUMMARYElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SUMMARYElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SUMMARYElement {
	if condition {
