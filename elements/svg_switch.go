...
func (e *SVGSWITCHElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SVGSWITCHElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGSWITCHElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SVGSWITCHElement {
	if condition {
