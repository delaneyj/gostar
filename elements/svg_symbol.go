...
func (e *SVGSYMBOLElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SVGSYMBOLElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGSYMBOLElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SVGSYMBOLElement {
	if condition {
