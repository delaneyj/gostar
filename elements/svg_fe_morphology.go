...
func (e *SVGFEMORPHOLOGYElement) DATASTAR_FETCH_URL(expression string) *SVGFEMORPHOLOGYElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGFEMORPHOLOGYElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *SVGFEMORPHOLOGYElement {
	if condition {
