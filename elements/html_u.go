...
func (e *UElement) DATASTAR_MERGE_STORE(v any) *UElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *UElement) DATASTAR_FETCH_URL(expression string) *UElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *UElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *UElement {
	if condition {
...
func (e *UElement) DATASTAR_FETCH_URLRemove() *UElement {
	if e.StringAttributes == nil {
		return e
	}
