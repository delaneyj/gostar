...
type UDataOnMod customDataKeyModifier

// Debounces the event handler
func UDataOnModDebounce(
	d time.Duration,
) UDataOnMod {
	return func() string {
...
func (e *UElement) DATASTAR_ON(key string, expression string, modifiers ...UDataOnMod) *UElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m UDataOnMod, i int) customDataKeyModifier {
...
func (e *UElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...UDataOnMod) *UElement {
	if condition {
...
func (e *UElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *UElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *UElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *UElement {
	if condition {
