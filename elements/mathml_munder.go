...
func (e *MathMLMUNDERElement) DATASTAR_ON(key string, expression string, modifiers ...MathMLMunderDataOnMod) *MathMLMUNDERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *MathMLMUNDERElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...MathMLMunderDataOnMod) *MathMLMUNDERElement {
	if condition {
...
func (e *MathMLMUNDERElement) DATASTAR_FETCH_URL(expression string) *MathMLMUNDERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *MathMLMUNDERElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *MathMLMUNDERElement {
	if condition {
...
func (e *MathMLMUNDERElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *MathMLMUNDERElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *MathMLMUNDERElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *MathMLMUNDERElement {
	if condition {
