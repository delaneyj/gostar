...
// User agents should ignore leading zeros. 
    ...
    // Setup the ViewTransitionAPI for the element 
        ...
        func(e *MathMLMUNDEROVERElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *MathMLMUNDEROVERElement{
                if e.StringAttributes == nil {
                    e.StringAttributes = treemap.New[string,string]()
                }
            ...
            func(e *MathMLMUNDEROVERElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *MathMLMUNDEROVERElement{
                if condition {
