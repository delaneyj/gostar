...
func (e *SVGSCRIPTElement) DATASTAR_FETCH_URL(expression string) *SVGSCRIPTElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGSCRIPTElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *SVGSCRIPTElement {
	if condition {
...
func (e *SVGSCRIPTElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SVGSCRIPTElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGSCRIPTElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SVGSCRIPTElement {
	if condition {
