...
func (e *MathMLMERRORElement) DATASTAR_FETCH_URL(expression string) *MathMLMERRORElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *MathMLMERRORElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *MathMLMERRORElement {
	if condition {
