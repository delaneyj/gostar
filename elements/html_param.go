...
func (e *PARAMElement) DATASTAR_MERGE_STORE(v any) *PARAMElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *PARAMElement) DATASTAR_FETCH_URL(expression string) *PARAMElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *PARAMElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *PARAMElement {
	if condition {
...
func (e *PARAMElement) DATASTAR_FETCH_URLRemove() *PARAMElement {
	if e.StringAttributes == nil {
		return e
	}
