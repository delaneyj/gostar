...
func (e *MAINElement) DATASTAR_ON(key string, expression string, modifiers ...MainDataOnMod) *MAINElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *MAINElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...MainDataOnMod) *MAINElement {
	if condition {
...
func (e *MAINElement) DATASTAR_FETCH_URL(expression string) *MAINElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *MAINElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *MAINElement {
	if condition {
...
func (e *MAINElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *MAINElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *MAINElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *MAINElement {
	if condition {
