...
func (e *MathMLMMULTISCRIPTSElement) DATASTAR_FETCH_URL(expression string) *MathMLMMULTISCRIPTSElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *MathMLMMULTISCRIPTSElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *MathMLMMULTISCRIPTSElement {
	if condition {
