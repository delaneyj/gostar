...
func (e *FIELDSETElement) DATASTAR_ON(key string, expression string, modifiers ...FieldsetDataOnMod) *FIELDSETElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *FIELDSETElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...FieldsetDataOnMod) *FIELDSETElement {
	if condition {
...
func (e *FIELDSETElement) DATASTAR_FETCH_URL(expression string) *FIELDSETElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *FIELDSETElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *FIELDSETElement {
	if condition {
...
func (e *FIELDSETElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *FIELDSETElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *FIELDSETElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *FIELDSETElement {
	if condition {
