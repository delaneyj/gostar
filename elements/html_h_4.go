...
func (e *H4Element) DATASTAR_MERGE_STORE(v any) *H4Element {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *H4Element) DATASTAR_FETCH_URL(expression string) *H4Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *H4Element) IfDATASTAR_FETCH_URL(condition bool, expression string) *H4Element {
	if condition {
...
func (e *H4Element) DATASTAR_FETCH_URLRemove() *H4Element {
	if e.StringAttributes == nil {
		return e
	}
