...
type H4DataOnMod customDataKeyModifier

// Debounces the event handler
func H4DataOnModDebounce(
	d time.Duration,
) H4DataOnMod {
	return func() string {
...
func (e *H4Element) DATASTAR_ON(key string, expression string, modifiers ...H4DataOnMod) *H4Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m H4DataOnMod, i int) customDataKeyModifier {
...
func (e *H4Element) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...H4DataOnMod) *H4Element {
	if condition {
...
func (e *H4Element) DATASTAR_VIEW_TRANSITION(key string, expression string) *H4Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *H4Element) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *H4Element {
	if condition {
