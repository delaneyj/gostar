...
func (e *DATAElement) DATASTAR_MERGE_STORE(v any) *DATAElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *DATAElement) DATASTAR_FETCH_URL(expression string) *DATAElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *DATAElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *DATAElement {
	if condition {
...
func (e *DATAElement) DATASTAR_FETCH_URLRemove() *DATAElement {
	if e.StringAttributes == nil {
		return e
	}
