...
func (e *LABELElement) DATASTAR_FETCH_URL(expression string) *LABELElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *LABELElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *LABELElement {
	if condition {
