...
func (e *LINKElement) DATASTAR_FETCH_URL(expression string) *LINKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *LINKElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *LINKElement {
	if condition {
...
func (e *LINKElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *LINKElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *LINKElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *LINKElement {
	if condition {
