...
func (e *LIElement) DATASTAR_FETCH_URL(expression string) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *LIElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *LIElement {
	if condition {
...
func (e *LIElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *LIElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *LIElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *LIElement {
	if condition {
