...
func (e *AElement) DATASTAR_ON(key string, expression string, modifiers ...ADataOnMod) *AElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *AElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...ADataOnMod) *AElement {
	if condition {
...
func (e *AElement) DATASTAR_FETCH_URL(expression string) *AElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *AElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *AElement {
	if condition {
...
func (e *AElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *AElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *AElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *AElement {
	if condition {
