...
func (e *LEGENDElement) DATASTAR_FETCH_URL(expression string) *LEGENDElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *LEGENDElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *LEGENDElement {
	if condition {
...
func (e *LEGENDElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *LEGENDElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *LEGENDElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *LEGENDElement {
	if condition {
