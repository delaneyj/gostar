...
func (e *SElement) DATASTAR_MERGE_STORE(v any) *SElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *SElement) DATASTAR_FETCH_URL(expression string) *SElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *SElement {
	if condition {
...
func (e *SElement) DATASTAR_FETCH_URLRemove() *SElement {
	if e.StringAttributes == nil {
		return e
	}
