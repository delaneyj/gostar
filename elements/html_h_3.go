...
func (e *H3Element) DATASTAR_MERGE_STORE(v any) *H3Element {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
func (e *H3Element) DATASTAR_FETCH_URL(expression string) *H3Element {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *H3Element) IfDATASTAR_FETCH_URL(condition bool, expression string) *H3Element {
	if condition {
...
func (e *H3Element) DATASTAR_FETCH_URLRemove() *H3Element {
	if e.StringAttributes == nil {
		return e
	}
