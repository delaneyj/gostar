...
func (e *SVGFEOFFSETElement) DATASTAR_MERGE_STORE(v any) *SVGFEOFFSETElement {
	if e.CustomDataAttributes == nil {
		e.CustomDataAttributes = treemap.New[string, string]()
	}
...
type SVGFeOffsetDataOnMod customDataKeyModifier

// Debounces the event handler
func SVGFeOffsetDataOnModDebounce(
	d time.Duration,
) SVGFeOffsetDataOnMod {
	return func() string {
...
func SVGFeOffsetDataOnModThrottle(
	d time.Duration,
) SVGFeOffsetDataOnMod {
	return func() string {
...
func (e *SVGFEOFFSETElement) DATASTAR_ON(key string, expression string, modifiers ...SVGFeOffsetDataOnMod) *SVGFEOFFSETElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
	...
	customMods := lo.Map(modifiers, func(m SVGFeOffsetDataOnMod, i int) customDataKeyModifier {
...
func (e *SVGFEOFFSETElement) IfDATASTAR_ON(condition bool, key string, expression string, modifiers ...SVGFeOffsetDataOnMod) *SVGFEOFFSETElement {
	if condition {
...
func (e *SVGFEOFFSETElement) DATASTAR_FETCH_URL(expression string) *SVGFEOFFSETElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGFEOFFSETElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *SVGFEOFFSETElement {
	if condition {
...
func (e *SVGFEOFFSETElement) DATASTAR_FETCH_URLRemove() *SVGFEOFFSETElement {
	if e.StringAttributes == nil {
		return e
	}
...
func (e *SVGFEOFFSETElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *SVGFEOFFSETElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *SVGFEOFFSETElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *SVGFEOFFSETElement {
	if condition {
