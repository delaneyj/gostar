...
func (e *WBRElement) DATASTAR_FETCH_URL(expression string) *WBRElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *WBRElement) IfDATASTAR_FETCH_URL(condition bool, expression string) *WBRElement {
	if condition {
...
func (e *WBRElement) DATASTAR_VIEW_TRANSITION(key string, expression string) *WBRElement {
	if e.StringAttributes == nil {
		e.StringAttributes = treemap.New[string, string]()
	}
...
func (e *WBRElement) IfDATASTAR_VIEW_TRANSITION(condition bool, key string, expression string) *WBRElement {
	if condition {
